...
const p1 = new Person("tushar", "upadhyay");
...
console.log(
  "car details using call",
  car1.cardetails.call(car2, "red", "5000")
);

console.log(
  "car details using apply",
  car1.cardetails.apply(car2, ["blue", "6000"])
);
